  ...
  return (
    <nav className="flex items-center text-xs text-slate-500 dark:text-slate-400 py-3 overflow-x-auto no-scrollbar">
      <button
        ...
        className="flex items-center gap-1 hover:text-teal-600 dark:hover:text-teal-400 transition shrink-0 font-medium"
      >
      ...
      {category && (
        <>
          ...
          <button
            ...
            className={`hover:text-teal-600 dark:hover:text-teal-400 transition shrink-0 font-medium ${
